...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary-800 via-secondary-900 to-primary-900 dark:from-dark-bg dark:via-dark-100 dark:to-primary-900 px-4 py-8">
      {/* Background Pattern */}
